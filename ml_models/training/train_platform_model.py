...
MODEL_OUTPUT = "ml_models/artifacts/platform_model.pkl"
LABEL_ENCODER_OUTPUT = "ml_models/artifacts/platform_label_encoder.pkl"
META_OUTPUT = "ml_models/artifacts/platform_meta.pkl"
...
def main():
    ...
    y = df["target_platform"].astype(str)
